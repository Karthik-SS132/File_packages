...
//A shortcut to store 'this' object represented by 'var salesinvoice_saleinvoice_cancel'
//Used for scoping methods of this object when they are invoked in a callback context
var _this;
var salesinvoice_saleinvoice_cancel = {
    /*
     ...
     */
    invokeAPI: function (cancel_salesinvoice_object)
    {
        _this = this;
		_this.returnValue = {};
        var requestdata = _this.prepareAPIRequest(cancel_salesinvoice_object);
        
        var contentType = "application/json";
        var responseFormat = "json";
        var targetURL = WebAPIProxy.getWebserverpath() + "api/salesinvoice/cancel_salesinvoice";
     ...
     */
    prepareAPIRequest: function (cancel_salesinvoice_object)
    {
        var request;
        request = "{";
        ...
        request = request + '"p_salesinvoice_no" : "' + WebAPIProxy.JSONEncode(cancel_salesinvoice_object.p_salesinvoice_no) + '"';  // Unicode string
        request = request + "}";
        request = request + "}";
        request = request + "}";
        return request;
