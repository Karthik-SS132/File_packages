DROP PROCEDURE IF EXISTS [dbo].[sp_save_manage_customer_loc_details] 
/****** Object:  StoredProcedure [dbo].[sp_save_manage_customer_loc_details]    Script Date: 21-12-2023 23:28:23 ******/
SET ANSI_NULLS ON
GO
...
*/
	...
	set @p_district=isnull( (select paramval from #input_params where paramname ='customer_location_district') ,'')	
...
begin
 ...
 begin
    ...
    (
	 ...
	 udf_analysis_code3,udf_analysis_code4,product_udf_char_1,
     last_update_id
    )
