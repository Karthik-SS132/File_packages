IF EXISTS(SELECT 1 FROM SYS.PROCEDURES WHERE NAME = 'sp_save_manage_custom_info_call_status_change_vi')
BEGIN
	DROP PROCEDURE [dbo].[sp_save_manage_custom_info_call_status_change_vi]
END
/****** Object:  StoredProcedure [dbo].[sp_save_manage_custom_info_call_status_change_vi]    Script Date: 28-12-2023 12:38:34 ******/
SET ANSI_NULLS ON
GO
...
create PROCEDURE [dbo].[sp_save_manage_custom_info_call_status_change_vi] 
...
BEGIN
	...
	else if @p_eventverb_id = 'MEETINGSTART'
	begin
