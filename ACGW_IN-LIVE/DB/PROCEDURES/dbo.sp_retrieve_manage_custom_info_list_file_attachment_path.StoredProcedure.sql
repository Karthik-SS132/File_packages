IF EXISTS(SELECT 1 FROM SYS.PROCEDURES WHERE NAME = 'sp_retrieve_manage_custom_info_list_file_attachment_path')
BEGIN
	DROP PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_file_attachment_path]
END
SET ANSI_NULLS ON
GO
