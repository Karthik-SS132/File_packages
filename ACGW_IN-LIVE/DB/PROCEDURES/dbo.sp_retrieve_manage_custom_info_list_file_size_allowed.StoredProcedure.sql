IF EXISTS(SELECT 1 FROM SYS.PROCEDURES WHERE NAME = 'sp_retrieve_manage_custom_info_list_file_size_allowed')
BEGIN
	DROP PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_file_size_allowed]
END
SET ANSI_NULLS ON
GO
 ...
 */
CREATE PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_file_size_allowed] 
...
BEGIN
	...
	select '' as custom_info_list,
		'{' +
			...
			'"description":"' + dbo.code_description(a.company_id, a.country_code, @i_locale_id, 'FILESIZE', a.type_code_value) + '"' +
		'}'
