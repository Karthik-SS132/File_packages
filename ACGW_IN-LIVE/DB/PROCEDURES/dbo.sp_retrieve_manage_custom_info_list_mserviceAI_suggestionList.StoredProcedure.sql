IF EXISTS(SELECT 1 FROM SYS.PROCEDURES WHERE NAME = 'sp_retrieve_manage_custom_info_list_mserviceAI_suggestionList')
BEGIN
	DROP PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_mserviceAI_suggestionList]
END
SET ANSI_NULLS ON
GO
