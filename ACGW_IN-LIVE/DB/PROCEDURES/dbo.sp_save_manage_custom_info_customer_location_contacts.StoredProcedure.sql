IF EXISTS(SELECT 1 FROM SYS.PROCEDURES WHERE NAME = 'sp_save_manage_custom_info_customer_location_contacts')
BEGIN
	DROP PROCEDURE [dbo].[sp_save_manage_custom_info_customer_location_contacts]
END
/****** Object:  StoredProcedure [dbo].[sp_save_manage_custom_info_customer_location_contacts]    Script Date: 26-07-2023 17:09:28 ******/
SET ANSI_NULLS ON
GO
