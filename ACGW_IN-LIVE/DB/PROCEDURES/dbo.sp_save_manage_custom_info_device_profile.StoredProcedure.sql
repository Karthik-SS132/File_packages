IF EXISTS(SELECT 1 FROM SYS.PROCEDURES WHERE NAME = 'sp_save_manage_custom_info_device_profile')
BEGIN
	DROP PROCEDURE [dbo].[sp_save_manage_custom_info_device_profile]
END
SET ANSI_NULLS ON
GO
