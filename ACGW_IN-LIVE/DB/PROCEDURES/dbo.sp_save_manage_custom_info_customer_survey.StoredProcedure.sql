IF EXISTS(SELECT 1 FROM SYS.PROCEDURES WHERE NAME = 'sp_save_manage_custom_info_customer_survey')
BEGIN
	DROP PROCEDURE [dbo].[sp_save_manage_custom_info_customer_survey]
END
SET ANSI_NULLS ON
GO
