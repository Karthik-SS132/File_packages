/****** Object:  UserDefinedFunction [dbo].[fn_get_client_specific_fields_for_my_activities]    Script Date: 10/25/2022 6:46:22 PM ******/
IF EXISTS(SELECT 1 FROM SYS.OBJECTS WHERE object_id = OBJECT_ID(N'[dbo].[fn_get_client_specific_fields_for_my_activities]') AND type IN ( N'FN', N'IF', N'TF', N'FS', N'FT' ))
BEGIN
	DROP FUNCTION [dbo].[fn_get_client_specific_fields_for_my_activities]
END
GO
