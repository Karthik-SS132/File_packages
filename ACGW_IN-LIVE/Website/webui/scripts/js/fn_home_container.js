/* Mservice Home Dashboard Script - Version 1.0.08 - 16/05/2023 */
...
var home_container = {
    constructScreen: function () {
        $.ajax({
            ...
            if (JSON.parse(data)["reportGroup"] !== undefined) {
                home_container.customRequirementHandler.getApplicableReports(JSON.parse(data)["reportGroup"]);
            } else {
               $("#home_container").prepend("<div id='home_container_empty_page'style='opacity:0.1; font-size:xxx-large; width:100%; height:60vh; text-align:center; font-weight: bold; display:flex; justify-content:center; align-items:center; '>Unable to Load Dashboard</div>");
            };
            ...
            $.ajax({
                url: mserviceUtilities.getWebserverpath() + "webui/configuration/ui/ui_home_container" + ".txt",
                async: false,
                cache: false
            }).done(function (data) {
                if (JSON.parse(data)["reportGroup"] !== undefined) {
    ...
    customRequirementHandler: {
        ...
        getApplicableReports: function (data) {
            var reportGroupCounter,
            reportListCounter;
            for (reportGroupCounter = 0; reportGroupCounter < data.length; reportGroupCounter++) {
                if ($.grep(access_profile.user_functional_access, function (element, index) {
                        return element.child_screen_id == data[reportGroupCounter].groupId && element.feature_access == "true";
                    }).length != 0) {
                    home_container.variable.custom.reportGroupList.push(JSON.parse(JSON.stringify(data[reportGroupCounter])));
                    home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList = [];
                    for (reportListCounter = 0; reportListCounter < data[reportGroupCounter].reportList.length; reportListCounter++) {
                        if ($.grep(access_profile.user_functional_access, function (element, index) {
                                return element.child_screen_id == data[reportGroupCounter].reportList[reportListCounter].reportId && element.feature_access == "true" && element.export_access == "true";
                            }).length != 0) {
                            home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList.push(data[reportGroupCounter].reportList[reportListCounter]);
                            home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList[home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList.length - 1].export.summary = "true";
							home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList[home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList.length - 1].export.detailedReport = "true";
							home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList[home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList.length - 1].export.chartImage = "true";
                        } else if ($.grep(access_profile.user_functional_access, function (element, index) {
                                return element.child_screen_id == data[reportGroupCounter].reportList[reportListCounter].reportId && element.feature_access == "true";
                            }).length != 0) {
                            home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList.push(data[reportGroupCounter].reportList[reportListCounter]);
                            home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList[home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList.length - 1].export.summary = "false";
							home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList[home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList.length - 1].export.detailedReport = "false";
							home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList[home_container.variable.custom.reportGroupList[home_container.variable.custom.reportGroupList.length - 1].reportList.length - 1].export.chartImage = "false";
                        };
                    };
                };
            };
        ...
        getGroupFilterValue: function (type, grpIndex) {
            ...
            dateTimeFilter,
            comboboxFilter;
            dropDownFilter = $("#home_container_report_group_filter_" + grpIndex).find("[data-widget-type='mDropdownlist']");
            for (index = 0; index < dropDownFilter.length; index++) {
                id = $(dropDownFilter[index]).attr("id").replace("home_container_report_group_filter_" + grpIndex + "_", "");
                returnValue += (type === "xml") ? ("<" + id + ">" + getXmlString($(dropDownFilter[index]).data("kendoDropDownList").value()) + "</" + id + ">") : ('"' + id + '":"' + $(dropDownFilter[index]).data("kendoDropDownList").text() + '",');
            };
            dateTimeFilter = $("#home_container_report_group_filter_" + "0").find("[data-widget-type='mDatepicker']");
            for (index = 0; index < dateTimeFilter.length; index++) {
                id = $(dateTimeFilter[index]).attr("id").replace("home_container_report_group_filter_" + "0" + "_", "");
                returnValue += (type === "xml") ? ("<" + id + ">" + getXmlString(mserviceUtilities.getDateString((($(dateTimeFilter[index]).data("kendoDatePicker").value() !== null) ? ($(dateTimeFilter[index]).data("kendoDatePicker").value()) : ("")), "yyyy-MM-dd")) + "</" + id + ">") : ('"' + id + '":"' + mserviceUtilities.getDateString((($(dateTimeFilter[index]).data("kendoDatePicker").value() !== null) ? ($(dateTimeFilter[index]).data("kendoDatePicker").value()) : ("")), "yyyy-MM-dd") + '",');
            };
            comboboxFilter = $("#home_container_report_group_filter_" + grpIndex).find("[data-widget-type='mCombobox']");
            for (index = 0; index < comboboxFilter.length; index++) {
                id = $(comboboxFilter[index]).attr("id").replace("home_container_report_group_filter_" + grpIndex + "_", "");
                returnValue += (type === "xml") ? ("<" + id + ">" + getXmlString($(comboboxFilter[index]).data("kendoComboBox").value()) + "</" + id + ">") : ('"' + id + '":"' + $(comboboxFilter[index]).data("kendoComboBox").text() + '",');
            };
        ...
        createGroupFilters: function (filterList, groupIndex) {
            ...
            for (groupFiltersIndex = 0; groupFiltersIndex < filterList.length; groupFiltersIndex++) {
                if (filterList[groupFiltersIndex].wType === "mDropdownlist") {
                    ...
                    html += "</span>";
                } else if (filterList[groupFiltersIndex].wType === "mCombobox") {
                    html += "<span style='padding-right: 1%; padding-bottom: 1%;'>";
                    html += "<div><label style='font-weight:bold;'>" + filterList[groupFiltersIndex].name + "</label></div>";
                    html += "<div><input style='width:" + ((filterList[groupFiltersIndex].width !== undefined) ? (filterList[groupFiltersIndex].width) : ("160")) + "px;' id='home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id + "' data-widget-type='" + filterList[groupFiltersIndex].wType + "' /></div>";
                    html += "</span>";
                } else if (filterList[groupFiltersIndex].wType === "mDatepicker") {
                    html += "<span style='padding-right: 1%; padding-bottom: 1%;'>";
                    html += "<div><label style='font-weight:bold;'>" + filterList[groupFiltersIndex].name + "</label></div>";
                    html += "<div><input style='width:" + ((filterList[groupFiltersIndex].width !== undefined) ? (filterList[groupFiltersIndex].width) : ("160")) + "px;' id='home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id + "' data-widget-type='" + filterList[groupFiltersIndex].wType + "' /></div>";
                    html += "</span>";
        ...
        initializeGroupFilters: function (filterList, groupIndex) {
            ...
            for (groupFiltersIndex = 0; groupFiltersIndex < filterList.length; groupFiltersIndex++) {
                if (filterList[groupFiltersIndex].wType === "mDropdownlist") {
                            ...
                            dataSource: {
                                transport: {
                                    ...
                                    parameterMap: function (data, type) {
                                        return '{"context":{"sessionId":"' + login_profile.guid_val + '","userId":"' + login_profile.user_id + '","client_id":"' + login_profile.client_id + '","locale_id":"' + login_profile.locale_id + '","country_code":"' + login_profile.country_code + '","inputparam":{"p_inputparam_xml":"' + filterList[groupFiltersIndex].inputparam + '"}}}';
                                    }
                                }
                            },
                            autoBind: true,
                    ...
                    var serverFilteringValue,
                    delayValue,
                    placeholderValue;
                    if (filterList[groupFiltersIndex].serverFiltering) {
                    ...
                    if (filterList[groupFiltersIndex].filterMode == true) {
                        placeholderValue = "ALL";
                    } else {
                        placeholderValue = "---Select---";
                    };
                    if (filterList[groupFiltersIndex].dataSrcType != undefined && filterList[groupFiltersIndex].dataSrcType == "dynamic") {
                        $("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).kendoComboBox({
                            dataSource: {
                                transport: {
                                    read: {
                                        url: mserviceUtilities.getWebserverpath() + "JSONServiceEndpoint.aspx?appName=common_modules&serviceName=retrieve_listof_values_for_searchcondition&path=context/outputparam",
                            ...
                            filtering: function (event) {
                                if (this.options.serverFiltering) {
                                    ...
                                    if (event.filter.value != "") {
                                        var filterElementId = this.element.context.id.replace("home_container_report_group_filter_" + home_container.variable.custom.activeGroupIndex + "_", "");
                                        var filterElementData = $.grep(home_container.variable.custom.reportGroupList[home_container.variable.custom.activeGroupIndex].groupFilters, function (data, index) {
                                                return data.id == filterElementId;
                                            });
                                        if (filterElementData.length != 0 && filterElementData[0].inputparam != undefined) {
                                            var filterElementXML = $.parseXML(filterElementData[0].inputparam);
                                            if (filterElementXML.getElementsByTagName("search_field_1")[0] != undefined) {
                                                filterElementXML.getElementsByTagName("search_field_1")[0].innerHTML = event.filter.value;
                                                filterElementData[0].inputparam = (new XMLSerializer()).serializeToString(filterElementXML);
                                            } else {
                                                filterElementData[0].inputparam = filterElementData[0].inputparam.replace("</inputparam>", "<search_field_1>" + event.filter.value + "</search_field_1></inputparam>");
                                            }
                                            this.dataSource.transport.parameterMap = function (data, type) {
                                                return '{"context":{"sessionId":"' + login_profile.guid_val + '","userId":"' + login_profile.user_id + '","client_id":"' + login_profile.client_id + '","locale_id":"' + login_profile.locale_id + '","country_code":"' + login_profile.country_code + '","inputparam":{"p_inputparam_xml":"' + filterElementData[0].inputparam + '"}}}';
                                            };
					...
					if (filterList[groupFiltersIndex].defaultValue != undefined) {
						try {
							$("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoComboBox").value(eval(filterList[groupFiltersIndex].defaultValue));
						} catch (e) {
							$("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoComboBox").value(filterList[groupFiltersIndex].defaultValue);
						}
					};
					if (filterList[groupFiltersIndex].disable != undefined && filterList[groupFiltersIndex].disable == "true") {
                        $("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoComboBox").enable(false);
                    };
                    if (filterList[groupFiltersIndex].id == "report_company_location_filter") {
                        if (login_profile.location_code != "NOLOC" && login_profile.location_code != "HO") {
                            $("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoComboBox").value(login_profile.location_code);
							$("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoComboBox").trigger("change");
                            $("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoComboBox").enable(false);
                        };
                    };
                    if (filterList[groupFiltersIndex].id == "report_dealer_code_filter") {
                        if (login_profile.dealer_code != "") {
                            $("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoComboBox").value(login_profile.dealer_code);
							$("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoComboBox").trigger("change");
                            $("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoComboBox").enable(false);
                        };
                    };
                } else if (filterList[groupFiltersIndex].wType === "mDatepicker") {
                    $("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).kendoDatePicker({
                        format: "dd-MM-yyyy",
                    ...
                    if (filterList[groupFiltersIndex].defaultValue != undefined) {
                        try {
                            $("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoDatePicker").value(eval(filterList[groupFiltersIndex].defaultValue));
                        } catch (e) {
                            $("#home_container_report_group_filter_" + groupIndex + "_" + filterList[groupFiltersIndex].id).data("kendoDatePicker").value(filterList[groupFiltersIndex].defaultValue);
                        };
                    };
                };
            };
        ...
        template: function (value, valueFormat, stackValueFormat) {
            if (value == undefined) {
                var result = "";
                return result;
            } else {
                if (stackValueFormat == "integer") {
                    value = Math.round(value);
                } else if (stackValueFormat == "decimal") {
                    value = parseFloat(value).toFixed(2);
                } else if (stackValueFormat != undefined && stackValueFormat != "decimal" && stackValueFormat.includes("decimal")) {
                    value = parseFloat(value).toFixed(((stackValueFormat.split(',')[1] != undefined && !isNaN(stackValueFormat.split(',')[1])) ? (stackValueFormat.split(',')[1].trim()) : (2)));
                ...
                if (valueFormat == true) {
                    ...
                    if (value.indexOf != undefined && value.indexOf(".") > 0) {
                        decimalValue = value.substring(value.indexOf("."), value.length);
                    };
                    currency = (Math.floor(value)).toString();
                        ...
                        read: {
                            ...
                            complete: function (data, textstatus) {
                                ...
                                if ($("#" + chartId).data("kendoChart").options.series != undefined && $("#" + chartId).data("kendoChart").options.series[0] != undefined && $("#" + chartId).data("kendoChart").options.series[0].stack == true) {
                                    if ($("#" + chartId).data("kendoChart").options.categoryAxis != undefined && $("#" + chartId).data("kendoChart").options.categoryAxis["categories"] != undefined && $("#" + chartId).data("kendoChart").options.categoryAxis["categories"].length != undefined) {
                                    ...
                                    $("#" + chartId).data("kendoChart").options.series[$("#" + chartId).data("kendoChart").options.series.length - 1].labels = {
                                        template: "#= home_container.customRequirementHandler.template(stackValue," + iObj.format + "," + '"' + iObj.seriesTotalRoundoff + '"' + ") #",
										visible: true
                                    }
    ...
    linkEventHandler: {
        ...
        dataview_action_link_click: function (element, event) {
            ...
            home_container.variable.custom.reportTypeList[reportIndex].detailedReport.forEach(function (e) {
                e.width = 150;
				if(e.allowFiltering !== undefined && e.allowFiltering === "true"){
					e.filterable = true;
				} else {
					e.filterable = false;
				};
