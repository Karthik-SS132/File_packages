var manage_call_register_pe_edit = {
	constructScreen : function () {
		...
		manage_call_register_pe_edit.variable.custom.datasource_5 = mserviceUtilities.getTransportDataSource({
				...
				pageSize : 8,
				inputParameter : {
					p_inputparam_xml : "<inputparam><lov_code_type>'CALL_REGISTER_ACTIONS'</lov_code_type><search_field_1>$manage_call_register_pe.variable.custom.selectedRecord.call_no</search_field_1><search_field_2>'PARTREQ'</search_field_2><search_field_3>$manage_call_register_pe.variable.custom.selectedRecord.call_category</search_field_3><search_field_4>$manage_call_register_pe.variable.custom.selectedRecord.call_type</search_field_4></inputparam>"
				},
				schemaModel : true,
		...
		if (manage_call_register_pe.variable.custom.crudIndicator == "U" || manage_call_register_pe.variable.custom.crudIndicator == "V") {
			...
			manage_call_register_pe_edit.variable.custom.lead_classification = manage_call_register_pe_edit.variable.custom.datasource_1_record.lead_classification; 
	...
	postConstruct : function () {
		if (manage_call_register_pe.variable.custom.crudIndicator == "V") {
			...
			$('#manage_call_register_pe_edit_priority_group dd.value span.display_description').append('<br/><span>'+manage_call_register_pe_edit.variable.custom.lead_classification +'</span>');		   
		}
	...
	initializeWidgets : function () {
		$("#manage_call_register_pe_edit_call_category").initializeWDropdownlist({
			...
			childFieldID : "manage_call_register_pe_edit_call_type, manage_call_register_pe_edit_priority"
		});
		...
		$("#manage_call_register_pe_edit_customer_contact_number").initializeWTextbox({
			screenID : "manage_call_register_pe_edit",
			maxlength : "20",
		...
		submit_btn_click : function (element, event) {
			...
			if (manage_call_register_pe_edit.variable.custom.grid_4 != undefined) {
				for (var index = 0; index < manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data().length; index++) {
					requirementEntryString += "<data><product_code>" + manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index].item_code + "</product_code><product_sub_code>" + manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index].item_variant_code + "</product_sub_code><uom_code>" + manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index].uom_code + "</uom_code><no_of_units>" + manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index].net_quantity + "</no_of_units><std_rate>" + manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index].std_rate + "</std_rate><gross_amount>" + manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index].gross_amount + "</gross_amount><requirement>" + manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index].requirement + "</requirement><action_type>" + manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index].action_type + "</action_type><action_category>" + manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index].action_category + "</action_category>";
					for(key in manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index]) {
						if((key.includes("udf")) || (key.includes("requirement_entry"))) {
							requirementEntryString += "<" + key + ">" + manage_call_register_pe_edit.variable.custom.grid_4.dataSource.data()[index][key] + "</" + key + ">";
						}
					}
