var manage_call_register_edit = {
	constructScreen : function () {
		...
		if (manage_call_register.variable.custom.crudIndicator == "U" || manage_call_register.variable.custom.crudIndicator == "V") {
			...
			manage_call_register_edit.variable.custom.datasource_1_record = manage_call_register_edit.variable.custom.datasource_1.at(0);
			...
			manage_call_register_edit.variable.custom.datasource_5 = mserviceUtilities.getTransportDataSource({
					applicationName : "common_modules",
					serviceName : "retrieve_listof_values_for_searchcondition",
					outputPath : "context/outputparam",
					pageSize : 8,
					inputParameter : {
						p_inputparam_xml : "<inputparam><lov_code_type>'CALL_REGISTER_ACTIONS'</lov_code_type><search_field_1>$manage_call_register.variable.custom.selectedRecord.call_no</search_field_1></inputparam>"
					},
					schemaModel : true,
					screenID : "manage_call_register_edit",
	...
	postConstruct : function () {
		if (manage_call_register.variable.custom.crudIndicator == "V") {
			$("#manage_call_register_edit_add_btn").hide();
			$("#manage_call_register_edit_edit_btn").hide();
			$("#manage_call_register_edit_view_btn").hide();
			$("#manage_call_register_edit_delete_btn").hide();
	...
	initializeWidgets : function () {
		...
		if (manage_call_register.variable.custom.crudIndicator == "A") {
			...
			manage_call_register_edit.variable.custom.grid_4 = $("#manage_call_register_edit_grid_4").initializeWGrid({
					screenID : "manage_call_register_edit",
					toolbar : "#manage_call_register_edit_grid_4_toolbar_template",
					dataSource : manage_call_register_edit.variable.custom.datasource_5,
					height : 300,
					pageSize : 8
				});
			...
			$("#manage_call_register_edit_grid_4 .k-grid-content").css("height", "232px");
		}
	},
	widgetEventHandler : {
		asset_id_change : function (element, event) {
			...
			if ($("#manage_call_register_edit_asset_id").getVal() != "ZZZ" && $("#manage_call_register_edit_asset_id").getVal() != "") {
				if (manage_call_register_edit.variable.custom.asset_id.dataItem() != undefined) {
					...
					if(manage_call_register_edit.variable.custom.asset_id.dataItem().contract_doc_no != undefined && manage_call_register_edit.variable.custom.displayDescription == "contract_doc_no"){
						$('#manage_call_register_edit_asset_id_group .display_description').text(manage_call_register_edit.variable.custom.asset_id.dataItem().contract_doc_no);
					}
					if(manage_call_register_edit.variable.custom.asset_id.dataItem().contract_type != undefined && manage_call_register_edit.variable.custom.displayDescription == "contract_type"){
						$('#manage_call_register_edit_asset_id_group .display_description').text(manage_call_register_edit.variable.custom.asset_id.dataItem().contract_type);
					}
					if(manage_call_register_edit.variable.custom.asset_id.dataItem().contract_duration != undefined && manage_call_register_edit.variable.custom.displayDescription == "contract_duration"){
						$('#manage_call_register_edit_asset_id_group .display_description').text(manage_call_register_edit.variable.custom.asset_id.dataItem().contract_duration);
					}
					if(manage_call_register_edit.variable.custom.asset_id.dataItem().effective_from_date != undefined && manage_call_register_edit.variable.custom.displayDescription == "effective_from_date"){
						$('#manage_call_register_edit_asset_id_group .display_description').text(manage_call_register_edit.variable.custom.asset_id.dataItem().effective_from_date);
					}
					if(manage_call_register_edit.variable.custom.asset_id.dataItem().effective_to_date != undefined && manage_call_register_edit.variable.custom.displayDescription == "effective_to_date"){
						$('#manage_call_register_edit_asset_id_group .display_description').text(manage_call_register_edit.variable.custom.asset_id.dataItem().effective_to_date);
					}
	...
	buttonEventHandler : {
		crud_btn_click : function (element, event) {
			if (manage_call_register_edit.variable.custom.crudIndicator == "D") {
				manage_call_register_edit.variable.custom.grid_4.dataSource.remove(manage_call_register_edit.variable.custom.selectedRecord);
				alert("Data deleted successfully.");
			} else if (mserviceUtilities.loadJSScripts(["../scripts/js/fn_manage_call_requirement_entry.js"])) {
				webNavigationController.gotoNextScreen({
					screenID : "manage_call_register_edit",
					fieldID : "manage_call_register_edit_child1_window",
		...
		submit_btn_click : function (element, event) {
			...
			/*if (login_profile.user_group_type == "LU") {
				if ($("#manage_call_register_edit_udf_analysis_code3").getVal() == "ACCR") {
					$("#manage_call_register_edit_servicing_org_level_number").setVal("3");
					$("#manage_call_register_edit_servicing_org_level_code").setVal("CRS");
				} else {
					$("#manage_call_register_edit_servicing_org_level_number").setVal("2");
					$("#manage_call_register_edit_servicing_org_level_code").setVal($("#manage_call_register_edit_udf_analysis_code3").getVal());
				}
			};*/
			inputString = $("#manage_call_register_edit_content_1").getInputparamXML({
					screenID : "manage_call_register_edit",
					matchCondition : ["manage_call_register_edit_udf"]
				});
			requirementEntryString = "<requirementEntry>";
			if (manage_call_register_edit.variable.custom.grid_4 != undefined) {
				for (var index = 0; index < manage_call_register_edit.variable.custom.grid_4.dataItems().length; index++) {
					requirementEntryString += "<data><item_code>" + manage_call_register_edit.variable.custom.grid_4.dataItems()[index].item_code + "</item_code><item_variant_code>" + manage_call_register_edit.variable.custom.grid_4.dataItems()[index].item_variant_code + "</item_variant_code><uom_code>" + manage_call_register_edit.variable.custom.grid_4.dataItems()[index].uom_code + "</uom_code><quantity>" + manage_call_register_edit.variable.custom.grid_4.dataItems()[index].net_quantity + "</quantity><std_rate>" + manage_call_register_edit.variable.custom.grid_4.dataItems()[index].std_rate + "</std_rate><gross_amount>" + manage_call_register_edit.variable.custom.grid_4.dataItems()[index].gross_amount + "</gross_amount><requirement>" + manage_call_register_edit.variable.custom.grid_4.dataItems()[index].requirement + "</requirement><action_type>" + manage_call_register_edit.variable.custom.grid_4.dataItems()[index].action_type + "</action_type><action_category>" + manage_call_register_edit.variable.custom.grid_4.dataItems()[index].action_type + "</action_category></data>";
				}
			};
			requirementEntryString += "</requirementEntry>";
			...
			if (returnValue.updateStatus == "SP001") {
				manage_call_register.variable.custom.acopcocallRefNo = returnValue.referenceNumber;
	...
	linkEventHandler : {
		...
		requirement_entry_tab_link_click : function (element, event) {
			if (manage_call_register_edit.variable.custom.requirementEntryTabOpened == false) {
				manage_call_register_edit.variable.custom.requirementEntryTabOpened = true;
				manage_call_register_edit.variable.custom.datasource_5.read();
			}
		}
	},
	customRequirementHandler : {
		...
		setSelectedRecord : function () {
			manage_call_register_edit.variable.custom.selectedRecord = manage_call_register_edit.variable.custom.grid_4.dataSource.getByUid(manage_call_register_edit.variable.custom.grid_4.select().data("uid"));
		}
	},
	variable : {
		standard : {
