...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="spm_report_readings">
		"Job #","Month","Type","Machine #","Model Id","Brand","Product Group","Product Subgroup","Employee Name","Dealer Code","Zone
		","Customer Id","Customer Name","Contact Name","Contact Number","Contact Email","Commissioning date"
		<xsl:for-each select="spm_report_readings">
			<br/>
			"=""<xsl:value-of select="call_no"/>""",
			"=""<xsl:value-of select="created_month"/>""",
			"=""<xsl:value-of select="spm_ind"/>""",
