...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="open_service_calls">
		"Job #","Job Type","Creation Month","Machine #","Model Id","Brand","Product Group","Product Subgroup","Employee Name","Dealer Code","Zone","Job Priority","Customer Requirement","Additional Info","Customer Id","Customer Name","Contact Name","Contact Number","Contact Email","Job Creation Date"
		<xsl:for-each select="open_service_calls">
			<br/>
