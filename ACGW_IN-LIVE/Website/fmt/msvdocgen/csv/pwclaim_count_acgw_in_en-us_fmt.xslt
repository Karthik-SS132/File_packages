...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="pwclaim_count">
		"ROC #","Status","Dealer Code","Employee Name","Company Location","Customer Name","Failure Reason","Loading Hours","Running Hours","Order Date","Expected Delivary","Receipt Date"
		<xsl:for-each select="pwclaim_count">
			<br/>
			"=""<xsl:value-of select="call_no"/>""",
			"=""<xsl:value-of select="pwclaim_status"/>""",
