...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="work_progress_period">
		"Job #","Job type","Work Progress Period","Dealer Code","Employee Name","Company Location","Customer Requirement","Additional Info","Customer Id","Customer Name","Contact Name","Contact Number","Contact Email"
		<xsl:for-each select="work_progress_period">
			<br/>
			"=""<xsl:value-of select="call_ref_no"/>""",
			"=""<xsl:value-of select="call_type"/>""",
			"=""<xsl:value-of select="work_progress_period"/>""",
