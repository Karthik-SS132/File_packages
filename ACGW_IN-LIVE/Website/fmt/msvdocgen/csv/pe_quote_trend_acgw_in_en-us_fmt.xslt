...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="pe_quote_trend">
		"Lead #","Quote date","Machine #","Machine Status","Model Id","Brand","Product Group","Product Subgroup","Dealer Code","Lead Source","Zone"
		<xsl:for-each select="pe_quote_trend">
			<br/>
