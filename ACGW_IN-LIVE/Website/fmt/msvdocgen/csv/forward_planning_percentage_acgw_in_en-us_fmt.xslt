...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="forward_planning_percentage">
		"Job #","Job type","forward planning Period","Dealer Code","Employee Name","Company Location","Customer Requirement","Additional Info","Customer Id","Customer Name","Contact Name","Contact Number","Contact Email"
		<xsl:for-each select="forward_planning_percentage">
			<br/>
			"=""<xsl:value-of select="call_ref_no"/>""",
			"=""<xsl:value-of select="call_type"/>""",
			"=""<xsl:value-of select="forward_planning_value"/>""",
