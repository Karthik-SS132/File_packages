...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="lead_creation_trend">
		"Lead #","Creation date","Lead Status","Machine #","Machine Status","Model Id","Brand","Product Group","Product Subgroup","Dealer Code","Lead Source","Zone"
		<xsl:for-each select="lead_creation_trend">
			<br/>
			"=""<xsl:value-of select="call_ref_no"/>""",
			"=""<xsl:value-of select="creation_date_time"/>""",
			"=""<xsl:value-of select="call_status"/>""",
