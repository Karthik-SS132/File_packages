...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:template match="sales_projection_count_lead_source">
		"Job #","Lead Source","Machine #","Machine Status","Model Id","Model Type","Date of Call","Customer Id","Customer Name","Dealer Code","Company Location"
		<xsl:for-each select="sales_projection_count_lead_source">
			<br/>
