						...
						<div style="display: flex;justify-content: space-between;margin-bottom: 1em;padding-left: 1em;flex-wrap: wrap;">
							<div>
								<div style="display: flex;margin-left: 1em;">
									<span style="color: #515050;font-size: 18px;font-weight: 600;padding-bottom: 1em;padding-top: 1em;">Use the verification code in this email to verify your email id for <xsl:value-of select="document/p_n_info_xml/notification_info/app_name"/> app.
									</span>
								</div>
