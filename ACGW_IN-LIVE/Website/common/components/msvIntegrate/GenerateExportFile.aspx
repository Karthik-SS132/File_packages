...
<script runat="server">
	protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.Write(msvIntegrate.InitiateExport(clientID, countryCode, localeID, userID, sessionID, documentType, documentTemplate, documentName, serviceName, serviceRequest, connectionStr));
    }
</script>