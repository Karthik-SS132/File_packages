			...
			<body>
				...
				<table border="1" >
					...
					<tr height="10px">
						...
						<td colspan="30" class="value" style="font-size:17px;text-align:left;">
							<xsl:value-of select="inputparam/mach_model_savedetails"/>
						</td>
						<td colspan="30" class="label">
							<b>Machine Serial No</b>
						</td>
						<td colspan="30" class="value" style="font-size:17px;text-align:left;">
							<xsl:value-of select="inputparam/mach_slno_savedetails"/>
						</td>
					</tr>
					<tr height="10px">
						<td colspan="30" class="label">
					...
					<table style="width:100%;">
						<tr>
							<td style="text-align:left;font-size:17px;">
								<b>Company address&#x3000;:</b>
								<br/>
								<br/><xsl:value-of select="inputparam/comp_name"/><br/><xsl:value-of select="inputparam/comp_address"/><br/>-<xsl:value-of select="inputparam/comp_pincode"/><br/>
							</td>
						</tr>
					</table>
					<br/>
