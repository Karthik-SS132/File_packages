...
BEGIN
   ...
   begin
	...
	begin
		...
		where company_id = @i_client_id 
			...
			and (effective_from_date is null
			     or 
				 SYSDATETIME() between effective_from_date and effective_to_date
				)
		return
	end
	...
	begin
		...
		begin
			select '' as value_list,
				...
				'' as o_value_field_3,
				b.first_name + ' ' + b.last_name as o_description_field_1,
				'' as o_description_field_2,
				'' as o_description_field_3
	...
	else if  @i_lov_code = 'INPUTMODE_LIST'
	begin
