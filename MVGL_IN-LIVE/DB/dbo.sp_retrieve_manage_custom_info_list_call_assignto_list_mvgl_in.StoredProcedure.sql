DROP PROCEDURE IF EXISTS[dbo].[sp_retrieve_manage_custom_info_list_call_assignto_list_mvgl_in]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_call_assignto_list_mvgl_in] 
