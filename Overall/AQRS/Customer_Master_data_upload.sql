...
'fiori', '170A214','DEALER','DEALER','Arpee Infra Corporation', 'Boulevard  opp viaay sales   sadhu vasvani chowk  Pune atation  Pune.411001', 'MHPU', 'MH', 'in', '', '', '', '', '', 'Mr Gupta', 9890020101, '', '', '', '', sysdatetimeoffset(), '034', 'BOTH', '', '', '', '', '', '', '', '', '', 0, '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'MHAHMDNGR'
		...
		from #customer
			...
			begin
				...
				begin
						select @p_session_id = NEWID(),@p_user_id = 'jothi'
