var manage_employee_master_edit = {
	...
	initializeWidgets : function () {
		...
		$("#manage_employee_master_edit_contact_number").initializeWMobilenumber({
			screenID : "manage_employee_master_edit",
			dataSource: {
			...
			dataValueField: "code",
			defaultValue : "$manage_employee_master_edit.variable.custom.contact_number_defaultValue"
		});
	...
	widgetEventHandler : {
		...
		contact_number_change : function (element, event) {
			alert("Test");
		}
	},
	buttonEventHandler : {
