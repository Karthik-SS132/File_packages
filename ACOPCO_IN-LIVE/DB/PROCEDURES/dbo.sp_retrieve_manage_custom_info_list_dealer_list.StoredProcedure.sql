DROP PROCEDURE IF EXISTS[dbo].[sp_retrieve_manage_custom_info_list_dealer_list]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_dealer_list] 
...
BEGIN
	...
	select '' as custom_info_list,
		'{' +
			...
			'"meeting_city":"' + a.ho_city+ '",' +
			'"meeting_district":"' + a.ho_city+ '",' +
			'"meeting_state":"' + a.ho_state_code + '"' +
		'}'
