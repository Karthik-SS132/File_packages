/****** Object:  StoredProcedure [dbo].[sp_retrieve_manage_custom_info_list_customer_timeline_acopco]    Script Date: 3/24/2023 3:24:22 PM ******/
IF EXISTS(SELECT 1 FROM SYS.PROCEDURES WHERE NAME = 'sp_retrieve_manage_custom_info_list_customer_timeline_acopco')
BEGIN
	DROP PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_customer_timeline_acopco]
END
GO
SET ANSI_NULLS ON
GO
 ...
 */
CREATE PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_customer_timeline_acopco] 
