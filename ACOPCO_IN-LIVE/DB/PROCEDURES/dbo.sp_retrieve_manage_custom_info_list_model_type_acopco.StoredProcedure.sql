DROP PROCEDURE IF EXISTS[dbo].[sp_retrieve_manage_custom_info_list_model_type_acopco]
GO
SET ANSI_NULLS ON
GO
 ...
 */
CREATE PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_model_type_acopco] 
...
BEGIN
	...
	select '' as custom_info_list,
		'{' +
			...
			'"equipment_category":"' + a.category_code_value + '"' +
		'}'
