DROP PROCEDURE IF EXISTS[dbo].[sp_save_manage_custom_info_call_status_change_se_acopco]
GO
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[sp_save_manage_custom_info_call_status_change_se_acopco] 
...
BEGIN
	...
	begin
			...
			if @@ROWCOUNT = 0
			begin
				set @i_error_msg = '{"code":"error_update_call_register_for_release_hold"}'
				return
			end
