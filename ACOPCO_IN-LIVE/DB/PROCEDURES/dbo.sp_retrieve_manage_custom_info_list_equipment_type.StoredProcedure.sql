DROP PROCEDURE IF EXISTS[dbo].[sp_retrieve_manage_custom_info_list_equipment_type]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_equipment_type] 
...
BEGIN
	...
	select distinct '' as value_list,
			'{' +
				'"code":"' + a.equipment_type + '",' +
				'"description":"' + a.equipment_id + '"' +
			'}' as o_value_xml
		from equipment a
