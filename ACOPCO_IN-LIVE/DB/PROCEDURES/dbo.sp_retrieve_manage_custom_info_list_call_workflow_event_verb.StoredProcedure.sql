/****** Object:  StoredProcedure [dbo].[sp_retrieve_manage_custom_info_list_call_workflow_event_verb]    Script Date: 3/24/2023 3:24:22 PM ******/
IF EXISTS(SELECT 1 FROM SYS.PROCEDURES WHERE NAME = 'sp_retrieve_manage_custom_info_list_call_workflow_event_verb')
BEGIN
	DROP PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_call_workflow_event_verb]
END
SET ANSI_NULLS ON
GO
