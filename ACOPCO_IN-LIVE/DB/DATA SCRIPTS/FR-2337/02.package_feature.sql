...
delete from package_feature where feature_id='MHMMYINSPCALL'and package_id=@p_package_id

INSERT [dbo].[package_feature] ([package_id], [module_id], [feature_id], [last_update_id]) VALUES (@p_package_id, N'DOUBLEO', N'MHMMYINSPCALL', N'system')

delete from package_feature where feature_id='MHMMYINSPFIL'and package_id=@p_package_id

INSERT [dbo].[package_feature] ([package_id], [module_id], [feature_id], [last_update_id]) VALUES (@p_package_id, N'DOUBLEO', N'MHMMYINSPFIL', N'system')

delete from package_feature where feature_id='MHMMYINSPREF'and package_id=@p_package_id

INSERT [dbo].[package_feature] ([package_id], [module_id], [feature_id], [last_update_id]) VALUES (@p_package_id, N'DOUBLEO', N'MHMMYINSPREF', N'system')
