...
IF NOT EXISTS( select 1 from company_notification where company_id = @p_company_id and country_code = @p_country_code and notification_event_code = 'VISITOR_PROFILE')
BEGIN
	INSERT company_notification (company_id, country_code, notification_event_code, description, active_ind, last_update_id) 	
