...
class notification_despatch
{
    ...
    {        
        ...
        {	
			...
			var msgToObject = JsonConvert.DeserializeObject<dynamic>(File.ReadAllText(AppDomain.CurrentDomain.BaseDirectory + "\\" + "content_store" + "\\" + clientID + "\\" + countryCode + "\\" + "msvMsg" + "\\" + "fcmtoken" + "\\" + userID + ".txt"));
