var manage_call_register_pe_edit = {
	constructScreen : function () {
		...
		if (manage_call_register_pe.variable.custom.crudIndicator == "U" || manage_call_register_pe.variable.custom.crudIndicator == "V") {
			...
			manage_call_register_pe_edit.variable.custom.datasource_1_record = $.extend({},manage_call_register_pe_edit.variable.custom.datasource_1.at(0).p_call_register_detail_json1, manage_call_register_pe_edit.variable.custom.datasource_1.at(0).p_call_register_detail_json2, manage_call_register_pe_edit.variable.custom.datasource_1.at(0).p_call_register_detail_json3);
	...
	initializeWidgets : function () {
		...
		if (manage_call_register_pe.variable.custom.crudIndicator == "A") {
			$("#manage_call_register_pe_edit_tabstrip").hide();
		} else {
	...
	buttonEventHandler : {
		...
		submit_btn_click : function (element, event) {
			...
			inputString = $("#manage_call_register_pe_edit_content_1").getInputparamXML({
					screenID : "manage_call_register_pe_edit",
					matchCondition : ["manage_call_register_pe_edit_udf"]
				});
			requirementEntryString = "<requirementEntry>";
			if (manage_call_register_pe_edit.variable.custom.grid_4 != undefined) {
				for (var index = 0; index < manage_call_register_pe_edit.variable.custom.grid_4.dataItems().length; index++) {
					requirementEntryString += "<data><item_code>" + manage_call_register_pe_edit.variable.custom.grid_4.dataItems()[index].item_code + "</item_code><item_variant_code>" + manage_call_register_pe_edit.variable.custom.grid_4.dataItems()[index].item_variant_code + "</item_variant_code><uom_code>" + manage_call_register_pe_edit.variable.custom.grid_4.dataItems()[index].uom_code + "</uom_code><quantity>" + manage_call_register_pe_edit.variable.custom.grid_4.dataItems()[index].net_quantity + "</quantity><std_rate>" + manage_call_register_pe_edit.variable.custom.grid_4.dataItems()[index].std_rate + "</std_rate><gross_amount>" + manage_call_register_pe_edit.variable.custom.grid_4.dataItems()[index].gross_amount + "</gross_amount><requirement>" + manage_call_register_pe_edit.variable.custom.grid_4.dataItems()[index].requirement + "</requirement><action_type>" + manage_call_register_pe_edit.variable.custom.grid_4.dataItems()[index].action_type + "</action_type><action_category>" + manage_call_register_pe_edit.variable.custom.grid_4.dataItems()[index].action_type + "</action_category></data>";
				}
			};
			requirementEntryString += "</requirementEntry>";
