...
function executeService_retrieve_manage_asset_master_list()
{
    ...
    //Prepare retrieve service request and invoke service 
    return executeServiceAsync(targetURL, prepareServiceRequestData_retrieve_manage_asset_master_list(), this.retrieve_manage_asset_master_list_ResponseHandler);

}

function retrieve_manage_asset_master_list_ResponseHandler(responseXML) 
{
    TT_Utils_Session.shell.closeLoader();
    ...
    {
        processServiceResponseData_retrieve_manage_asset_master_list(responseXML);
        return true;
    }
    return false;
}
