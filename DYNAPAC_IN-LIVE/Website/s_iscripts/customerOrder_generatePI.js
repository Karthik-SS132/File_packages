/* 
 * This file contains invocation code snippets for executing the API operation 'generatePI'.
 ...
 * Include reference to this snippet file in the html page or javascript file from where the API operation 'generatePI' would be invoked.
...
//A shortcut to store 'this' object represented by 'var salesinvoice_customerOrder_generatePI'
//Used for scoping methods of this object when they are invoked in a callback context
var _this;
var salesinvoice_customerOrder_generatePI = {
    /*
     ...
     */
    invokeAPI: function (generate_proforma_invoice_object)
    {
        _this = this;
		_this.returnValue = {};
        var requestdata = _this.prepareAPIRequest(generate_proforma_invoice_object);
        
        var contentType = "application/json";
        var responseFormat = "json";
        var targetURL = WebAPIProxy.getWebserverpath() + "api/salesinvoice/generate_proforma_invoice";
    ...
    //Code for preparing input data for the api generatePI
    /* 
     ...
     */
    prepareAPIRequest: function (generate_proforma_invoice_object)
    {
        var request;
        request = "{";
        ...
        request = request + '"p_txn_ref_no_ind" : "' + WebAPIProxy.JSONEncode(generate_proforma_invoice_object.p_txn_ref_no_ind) + '"';  // String
        request += ',';
        request = request + '"p_txn_ref_no" : "' + WebAPIProxy.JSONEncode(generate_proforma_invoice_object.p_txn_ref_no) + '"';  // Unicode string
        request = request + "}";
        request = request + "}";
        request = request + "}";
        return request;
    ...
    /**************************************************************************************************************************/
    /*
     * Response handler function of API operation 'generatePI'
     */
    ...
    //Code for processing response data from the API operation 'generatePI'
