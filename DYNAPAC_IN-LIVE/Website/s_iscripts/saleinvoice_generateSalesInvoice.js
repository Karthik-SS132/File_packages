/* 
 * This file contains invocation code snippets for executing the API operation 'generateSalesInvoice'.
 ...
 * Include reference to this snippet file in the html page or javascript file from where the API operation 'generateSalesInvoice' would be invoked.
...
//A shortcut to store 'this' object represented by 'var salesinvoice_saleinvoice_generateSalesInvoice'
//Used for scoping methods of this object when they are invoked in a callback context
var _this;
var salesinvoice_saleinvoice_generateSalesInvoice = {
    /*
     * Resource: saleinvoice
     * Description: To generate salesinvoice
     * Http verb: POST
     * Request format: JSON
     * Response format: JSON
     * Requires authorization: No
     */
    invokeAPI: function (generate_salesinvoice_document_object)
    {
        _this = this;
		_this.returnValue = {};
        var requestdata = _this.prepareAPIRequest(generate_salesinvoice_document_object);
        
        var contentType = "application/json";
        var responseFormat = "json";
        var targetURL = WebAPIProxy.getWebserverpath() + "api/salesinvoice/generate_salesinvoice_document";
    ...
    //Code for preparing input data for the api generateSalesInvoice
    /* 
     ...
     */
    prepareAPIRequest: function (generate_salesinvoice_document_object)
    {
        var request;
        request = "{";
        ...
        request = request + '"p_customer_order_no" : "' + WebAPIProxy.JSONEncode(generate_salesinvoice_document_object.p_customer_order_no) + '"';  // Unicode string
        request = request + "}";
        request = request + "}";
        request = request + "}";
        return request;
    ...
    /**************************************************************************************************************************/
    /*
     * Response handler function of API operation 'generateSalesInvoice'
     */
    ...
    //Code for processing response data from the API operation 'generateSalesInvoice'
    bindAPIResponseToUserControl: function (responseJSON)
    {
        ...
        _this.returnValue.invoice_no = outoutputparam_header.p_invoice_no;   //p_invoice_no
