...
INSERT [dbo].[package_feature] ([package_id], [module_id], [feature_id], [last_update_id]) VALUES (@p_package_id, N'DOUBLEO', N'MCALLDETAILS', N'system')

delete from package_feature where feature_id='MUSERATTACHMENT'and package_id=@p_package_id

INSERT [dbo].[package_feature] ([package_id], [module_id], [feature_id], [last_update_id]) VALUES (@p_package_id, N'DOUBLEO', N'MUSERATTACHMENT', N'system')
...
IF NOT EXISTS (select 1 from package_feature where feature_id='MHMPUNCHINOUT')
	BEGIN
		INSERT INTO package_feature(package_id, module_id, feature_id, last_update_id)
		VALUES
		(
			@p_package_id, 'DOUBLEO', 'MHMPUNCHINOUT', 'system'
		);
	END
...
delete from package_feature where feature_id='MHMMYSERVICALL'and package_id=@p_package_id

INSERT [dbo].[package_feature] ([package_id], [module_id], [feature_id], [last_update_id]) VALUES (@p_package_id, N'DOUBLEO', N'MHMMYSERVICALL', N'system')

delete from package_feature where feature_id='MHMMYSERVIFIL'and package_id=@p_package_id

INSERT [dbo].[package_feature] ([package_id], [module_id], [feature_id], [last_update_id]) VALUES (@p_package_id, N'DOUBLEO', N'MHMMYSERVIFIL', N'system')

delete from package_feature where feature_id='MHMMYSERVIREF'and package_id=@p_package_id

INSERT [dbo].[package_feature] ([package_id], [module_id], [feature_id], [last_update_id]) VALUES (@p_package_id, N'DOUBLEO', N'MHMMYSERVIREF', N'system')
