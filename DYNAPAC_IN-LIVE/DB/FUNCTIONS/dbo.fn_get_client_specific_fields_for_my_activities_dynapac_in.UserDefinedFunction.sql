...
DROP FUNCTION IF EXISTS [dbo].[fn_get_client_specific_fields_for_my_activities_dynapac_in]
Go
SET ANSI_NULLS ON
GO
...
CREATE function [dbo].[fn_get_client_specific_fields_for_my_activities_dynapac_in]
(
