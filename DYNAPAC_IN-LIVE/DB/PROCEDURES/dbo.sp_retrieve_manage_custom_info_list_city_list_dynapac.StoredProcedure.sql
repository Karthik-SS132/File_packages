DROP PROCEDURE IF EXISTS[dbo].[sp_retrieve_manage_custom_info_list_city_list_dynapac]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_city_list_dynapac] 
