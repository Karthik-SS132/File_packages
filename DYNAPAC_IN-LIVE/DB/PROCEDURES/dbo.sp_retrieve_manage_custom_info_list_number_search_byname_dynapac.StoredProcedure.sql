DROP PROCEDURE IF EXISTS[dbo].[sp_retrieve_manage_custom_info_list_number_search_byname_dynapac]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_number_search_byname_dynapac] 
...
BEGIN
	...
	select '' as custom_info_list,
		'{' +
			...
			'"contact_person_mobile_no":"' +isnull(a.contact_person_1,'') +'",'+
