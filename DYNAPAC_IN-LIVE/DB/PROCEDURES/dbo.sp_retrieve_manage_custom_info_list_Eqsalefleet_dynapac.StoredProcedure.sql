DROP PROCEDURE IF EXISTS[dbo].[sp_retrieve_manage_custom_info_list_Eqsalefleet_dynapac]
GO
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE PROCEDURE [dbo].[sp_retrieve_manage_custom_info_list_Eqsalefleet_dynapac] 
...
BEGIN
	...
	select '' as custom_info_list,
		...
		where a.company_id = @i_client_id
			...
			and a.value_mapping_code = 'EQSALEFLEET'
